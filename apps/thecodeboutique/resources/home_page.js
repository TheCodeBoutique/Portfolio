  ...
  mainPane: SC.MainPane.design({
    ...
    middleView:SC.View.design({
			...
			slideShow: SC.ImageView.design({
				...
				imageArray:function() {
					var images = [];
					var image2 = sc_static('/images/tutorials.png');
					var image4 = sc_static('/images/animate.png');
					var image6 = sc_static('/images/hacktime.png');
			...
			slideShowBack: SC.ImageView.design({
				...
				imageArray:function(){
					var images = [];
					var image1 = sc_static('/images/comunity.png');
					var image3 = sc_static('/images/end.png');
					var image5 = sc_static('/images/Game.png');
					...
					fadeit:function(){
						...
						var active = sc_static('/images/slideshowActive.png');
						var inactive = sc_static('/images/slideshowNotActive.png');
						if(t === 0){
			    ...
			    childViews:'selector1 selector2 selector3 selector4 selector5 selector6'.w(),
					...
					selector1:SC.ImageView.design({
						...
						useImageQueue: NO, 
						value: sc_static('/images/slideshowNotActive.png'),
					}),

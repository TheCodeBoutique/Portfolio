...
module("Ki.HistoryState - Without Concurrent States Tests", {
  setup: function() {
...
test("check initial substate after statechart init", function() {
  ...
  equals(SC.kindOf(aInitSubstate, Ki.HistoryState), true, "a state's initial substate should be of type Ki.HistoryState");
  ...
  equals(SC.kindOf(bInitSubstate, Ki.HistoryState), true, "b state's initial substate should be of type Ki.HistoryState");

...
module("Ki.Statechart: Namespace - Access Substate Tests", {
  setup: function() {
    
    statechart1 = Ki.Statechart.create({
      
      rootState: Ki.State.design({
        initialSubstate: 'a',
        a: Ki.State.design({ value: 'state A' }),
        b: Ki.State.design({ value: 'state B' })
      })
      
    });
    
    statechart2 = Ki.Statechart.create({
      ...
      rootState: Ki.State.design({
        ...
        a: Ki.State.design({
          value: 'state A',
          initialSubstate: 'c',
          c: Ki.State.design({ value: 'state C' }),
          d: Ki.State.design({ value: 'state D' })
        }),
        
        b: Ki.State.design({
          value: 'state B',
          initialSubstate: 'e',
          e: Ki.State.design({ value: 'state E' }),
          f: Ki.State.design({ value: 'state F' })
        })
      })
      
    });
    
    statechart3 = Ki.Statechart.create({
      ...
      rootState: Ki.State.design({
        ...
        b: Ki.State.design({
          value: 'state B',
          initialSubstate: 'a',
          a: Ki.State.design({ value: 'state B.A' }),
          c: Ki.State.design({
            value: 'state C',
            initialSubstate: 'a',
            a: Ki.State.design({ value: 'state B.C.A' }),
            d: Ki.State.design({ value: 'state D' })
          })
        })
      })
    ...
    statechart4 = Ki.Statechart.create({
      ...
      rootState: Ki.State.design({
        ...
        a: Ki.State.design({
          value: 'state A',
          initialSubstate: 'x',
          x: Ki.State.design({ value: 'state A.X' }),
          y: Ki.State.design({ value: 'state A.Y' })
        }),
        
        b: Ki.State.design({
          value: 'state B',
          initialSubstate: 'x',
          x: Ki.State.design({ value: 'state B.X' }),
          y: Ki.State.design({ value: 'state B.Y' })
        })
      })
